...
type CmdAction = 'panel' | 'show' | 'add' | 'delete' | 'import';
...
const SECTIONS: Section[] = [
  {
    ...
    available: true,
    commands: [
      { cmd: 'finanza completa',            desc: 'Pannello finanze con tutti i tab',  action: 'panel',  fragment: 'FinancePanorama',  fragmentParams: {} },
      { cmd: 'mostrami le spese',           desc: 'Lista ultime uscite',               action: 'show',   fragment: 'FinanceList',      fragmentParams: { limit: 8, type: 'expense' } },
      { cmd: 'riepilogo finanze',           desc: 'KPI del mese corrente',             action: 'panel',  fragment: 'FinanceOverview',  fragmentParams: {} },
      ...
      { cmd: 'analisi finanziaria',         desc: 'Grafici e trend avanzati',          action: 'panel',  fragment: 'FinanceAnalytics', fragmentParams: {} },
      { cmd: 'spese per categoria',         desc: 'Raggruppa le transazioni',          action: 'panel',  fragment: 'FinanceCategory',  fragmentParams: {} },
      ...
      { cmd: 'importa il tuo estratto conto', desc: 'Formati supportati: CSV, XLSX, XLS, PDF', action: 'import', fragment: 'FinancePanorama', fragmentParams: { tab: 'importa' } },
    ],
  },
  {
    id: 'health',
    ...
    available: true,
    commands: [
      { cmd: 'riepilogo salute',            desc: 'Panoramica salute',               action: 'panel', fragment: 'HealthOverview', fragmentParams: {} },
      ...
      { cmd: 'configura profilo salute',    desc: 'Anagrafica e obiettivi iniziali', action: 'panel', fragment: 'HealthSetup',    fragmentParams: {} },
    ],
  },
  {
    id: 'psych',
    ...
    available: true,
    commands: [
      { cmd: 'come sto?',                   desc: 'Umore attuale + media recente',   action: 'panel', fragment: 'PsychOverview', fragmentParams: {} },
  ...
  },
  {
    ...
    available: true,
    commands: [
      { cmd: 'apri impostazioni',           desc: 'Profilo, tema, sicurezza',        action: 'panel', fragment: 'Settings', fragmentParams: {} },
      { cmd: 'cambia tema',                 desc: 'Seleziona il tema dell\'app',     action: 'panel', fragment: 'Settings', fragmentParams: { tab: 'tema' } },
  ...
  },
  {
    ...
    available: false,
    commands: [
      { cmd: 'apri appunti',                desc: 'Archivio note e riflessioni',     action: 'panel', prefill: 'apri appunti' },
  ...
  },
  {
    ...
    available: false,
    commands: [
      { cmd: 'routine di oggi',             desc: 'Task e tracker del giorno',       action: 'panel', prefill: 'routine di oggi' },
  ...
  },
  {
    ...
    available: false,
    commands: [
      { cmd: 'mostrami le news',            desc: 'Feed personalizzato',             action: 'panel', prefill: 'mostrami le news' },
  ...
  },
  {
    ...
    available: false,
    commands: [
      { cmd: 'apri carriera',               desc: 'Obiettivi professionali',         action: 'panel', prefill: 'apri carriera' },
  ...
  },
  {
    ...
    available: false,
    commands: [
      { cmd: 'i miei badge',                desc: 'Collezione badge e XP',           action: 'panel', prefill: 'i miei badge' },
  ...
  },
  {
    ...
    available: true,
    commands: [
      { cmd: 'segnala un bug',              desc: 'Apri il form di segnalazione',    action: 'panel', fragment: 'BugReport',       fragmentParams: {} },
      { cmd: 'proponi miglioria',           desc: 'Suggerisci un miglioramento',     action: 'panel', fragment: 'BugReport',       fragmentParams: { tab: 'improvement' } },
    ],
  },
  {
    id: 'admin',
    ...
    available: true,
    commands: [
      { cmd: 'accedi alla sezione admin',   desc: 'Pannello ticket (password)',      action: 'panel', fragment: 'Admin',           fragmentParams: {} },
    ],
  },
  {
    id: 'chatbot',
  ...
  return (
    <NebulaCard title="Cosa sa fare Nebula" variant="default" closable>
      ...
      <div className="help-filters">
        {FILTERS.map((f) => (
          <button
            ...
            style={f.id === 'panel' && filter === f.id ? { background: 'rgba(245,158,11,0.15)', borderColor: 'rgba(245,158,11,0.5)', color: '#fbbf24' } : undefined}
      ...
      <p className="help-footer">
        <span style={{ color: ACTION_COLOR.panel }}>●</span> pannello &nbsp;
